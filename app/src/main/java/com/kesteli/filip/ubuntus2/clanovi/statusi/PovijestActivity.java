...
import com.kesteli.filip.ubuntus2.clanovi.statusi.adapters.PovijestAdapter;
...
public class PovijestActivity extends AppCompatActivity {
    ...
    private PovijestAdapter adapter;
    ...
    private void setupRecyclerView() {
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_povijest);

        albumList = new ArrayList<>();
        adapter = new PovijestAdapter(this, albumList);
    ...
    private void initCollapsingToolbar() {
        final CollapsingToolbarLayout collapsingToolbar =
                (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbarPovijest);
        collapsingToolbar.setTitle(" ");
        AppBarLayout appBarLayout = (AppBarLayout) findViewById(R.id.appbarPovijest);
