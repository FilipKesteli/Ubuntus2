...
public class PrihvacenoActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private PrihvacenoAdapter adapter;
    ...
    private void setupRecyclerView() {
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_prihvaceno);

        albumList = new ArrayList<>();
        adapter = new PrihvacenoAdapter(this, albumList);
